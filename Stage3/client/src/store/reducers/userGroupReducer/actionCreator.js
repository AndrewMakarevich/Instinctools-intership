...
export const getUserGroupsThunk = (userId, filterObject, page, limit) => async (dispatch) => {
...
export const getGroupUsersThunk = (groupId, filterObject, page, limit) => async (dispatch) => {
...
export const getNotGroupMembersThunk = (groupId, filterObject, page, limit) => async (dispatch) => {
